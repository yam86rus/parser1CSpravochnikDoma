...
public class Parser {
            ...
            *ВАЖНО! Если в маске нет название улицы, значит это Виртуальная улица, или по другому, если нет скобок - улица Виртуальная
            --------------------------------------------------------
            ...
            ВПР ДЕЛАТЬ ТОЛЬКО ПО населеному пунтку и номеру.
            Название улицы проблел ул в скобках населеный пункт запятая номер дома, без дом. участок. уч. и прочей шляпы
            иначе ничего не ищется с этими участками и прочее.
            Пример впр:
            Сибирскяк&Иртышская&15
            Данные в билинге: Иртышская ул (Сибиряк п), уч. № 15	уч.	15
            Данные от заказчика: Сибиряк	ул	Иртышская	Домовладение дом	15
    ...
    public static String parse(String str) {
        ...
        if (countComa == 1 && countBracket == 1) {
            ...
            result = "Данную маску еще не обработали.";
        }
        return result;
    }
}
